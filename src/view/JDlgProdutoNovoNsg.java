 ...
 * @author nayar
 */
public class JDlgProdutoNovoNsg extends javax.swing.JDialog {

    /**
     * Creates new form JDlgProdutoNovoNsg
     */
    
    private JDlgProdutoNovoIANsg jDlgProdutoNovoIANsg;
    ProdutoControleNsg produtoControleNsg;
    Produto_DAO_Nsg produto_DAO_Nsg;
    ProdutoNsg produtoNsg;
    
    public JDlgProdutoNovoNsg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Inclusão de produtos");
        setLocationRelativeTo(null);
        
        jDlgProdutoNovoIANsg = new JDlgProdutoNovoIANsg(null, true);
    ...
    private void jBtnIncluir_NsgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluir_NsgActionPerformed
        ...
        jDlgProdutoNovoIANsg.setTitle("Incluir");
        jDlgProdutoNovoIANsg.setVisible(true);
    ...
    private void jBtnAlterar_NsgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterar_NsgActionPerformed
        // TODO add your handling code here:
        jDlgProdutoNovoIANsg.setTitle("Alterar");
        jDlgProdutoNovoIANsg.setVisible(true);
    ...
    private void jBtnExcluir_NsgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluir_NsgActionPerformed
        ...
        if (Util.perguntar("Deseja excluir produto?") == true){
            ...
            produtoNsg = produtoControleNsg.getBean(sel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgProdutoNovoNsg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgProdutoNovoNsg dialog = new JDlgProdutoNovoNsg(new javax.swing.JFrame(), true);
